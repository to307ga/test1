...
echo "MFA認証用スクリプト (PROD環境)"
echo "現在のMFAデバイス: arn:aws:iam::007773581311:mfa/prod_toshimitsu.tomonaga.zd"
echo ""
echo "使用方法:"
echo "  ./get_mfa_token_prod.sh [MFAトークンコード]"
echo ""
echo "例："
echo "  ./get_mfa_token_prod.sh 123456"
echo ""
...
echo "MFAトークン $TOKEN_CODE で認証中... (PROD環境)"
...
if [ $? -eq 0 ]; then
    ...
    CREDENTIALS_FILE="$(dirname "$0")/../aws_mfa_credentials_prod"
